...
export class Tab1Page 
{
  ...
  {
    this.timesSlept = [];
    this.timesSleptDates = [];
    this.week_timesSlept = [];
    this.week_timesSleptDates = [];
  ...
  ionViewWillLeave() {
    // Destroy chart instances to prevent memory leaks and ensure clean initialization when returning to the tab
    if (this.myChart) {
